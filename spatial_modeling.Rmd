...
<h1>🗽 NYC Spatial Analysis with Real Boundaries</h1>
...
leaflet(spatial_data_2023) %>%
  ...
  addPolygons(
    ...
    label = ~paste0(
      ...
      "PM2.5: ", round(pm25_annual, 1), " μg/m³<br/>",
      "Summer: ", round(pm25_summer, 1), " μg/m³<br/>",
      "Winter: ", round(pm25_winter, 1), " μg/m³"
    ) %>% lapply(htmltools::HTML),
    popup = ~paste0(
      "<div style='font-size: 14px;'>",
      "<h4 style='color: #2563eb; margin-bottom: 10px;'>", borough, "</h4>",
      "<strong>Annual PM2.5:</strong> ", round(pm25_annual, 1), " μg/m³<br/>",
      "<strong>Summer PM2.5:</strong> ", round(pm25_summer, 1), " μg/m³<br/>",
      "<strong>Winter PM2.5:</strong> ", round(pm25_winter, 1), " μg/m³<br/>",
...
<h4>🗺️ Choropleth Map Advantages</h4>
**Real boundaries** show the actual geographic extent of each borough, unlike point markers. You can now see:
- Relative size of each borough
- Actual shapes and boundaries
- Continuous color fill representing pollution levels
...
<div class="spatial-insight">
<h4>🏥 Geographic Health Disparity</h4>
...
- **Size-health relationship**: Borough size ≠ health burden
